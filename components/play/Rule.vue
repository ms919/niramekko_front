		...
		text() {
			...
			switch (this.mode) {
				case fixed.MODE.NORMAL:
					return (
							`最初に${fixed.PERFECT_SCORE}スコアが付与されます。<br/>tiktokのおもしろ動画を見て、笑いを堪えてください。5つの動画を再生後、最終スコアによって称号が決まります。<br/>高スコアを目指して笑いを堪らえよう！`
					);
				case fixed.MODE.DOJYO:
					return (
						`最も笑われている動画ベストを見て笑いを堪えるモードです。<br/>最初に${fixed.ADDITIONAL_SCORE}スコアが付与され、その後は各動画クリア毎に${fixed.ADDITIONAL_SCORE}スコアが付与されます。笑いを堪えきれないとゲームオーバーになります。ゲームクリアを目指して笑いを堪らえよう！`
					);
				case fixed.MODE.REVENGE:
					return (
						`過去に笑ってしまった動画にリベンジするモードです。<br/>最初に${fixed.ADDITIONAL_SCORE}スコアが付与され、その後は各動画クリア毎に${fixed.ADDITIONAL_SCORE}スコアが付与されます。笑いを堪えきれないとゲームオーバーになります。ゲームクリアを目指して笑いを堪らえよう！`
					);
				default:
					""
			}
